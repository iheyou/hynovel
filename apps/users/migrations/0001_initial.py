# Generated by Django 2.0.2 on 2018-03-05 08:26
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user_nickname', models.CharField(default=models.CharField(max_length=18, verbose_name='用户名'), max_length=20, verbose_name='昵称')),
                ('user_email', models.CharField(max_length=18, null=True, verbose_name='邮箱')),
                ('user_image', models.ImageField(null=True, upload_to='', verbose_name='用户头像')),
        ...
        migrations.CreateModel(
            name='UserCollectNovels',
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('novel_identify', models.CharField(max_length=50, verbose_name='小说标识')),
                ('novel_name', models.CharField(default=None, max_length=50, verbose_name='书名')),
                ('novel_image', models.CharField(default=None, max_length=100, verbose_name='小说封面')),
